...
* Resuelto problema de datos guardados en Tran41sients luego de actualización a 1.4.40 por cambio de nombres de regiones en WooCommerce 6.0. Ver [issue #230](https://github.com/whooohq/whq-woocommerce-chilexpress-shipping/issues/230). Gracias a @2xffwd por el aviso.

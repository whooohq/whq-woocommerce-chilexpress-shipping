...
function whq_wcchp_checkout_inputs_replace() {
	if( jQuery('#billing_city, #shipping_city').is('input') ) {
		...
		jQuery("#billing_whq_city").after('<select id="billing_whq_citopt" name="billing_whq_citopt" disabled="disabled"><option value="">Selecciona la región primero.</option></select>');
		...
		jQuery("#shipping_whq_city").after('<select id="shipping_whq_citopt" name="shipping_whq_citopt" disabled="disabled"><option value="">Selecciona la región primero.</option></select>');
